...
import { hashPassword, generateToken, getUserSubscription, formatSubscription, setCors } from '../_lib/helpers.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const sub = await getUserSubscription(reset.user_id);
